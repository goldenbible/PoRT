...
<?php
	$statement = $dbh -> prepare('select msg.subject, msg.message, u.nickname, msg.from_user_id, msg.to_user_id from messages msg
...
?>
	<div class="row">
		...
		<div class="col-md-3">
			<p><a href="./?menu=user_profile&id=<?=$message_row['to_user_id'];?>"><?=$message_row['nickname'];?></a></p>
		</div>
	</div>
	<div class="row">
		<div class="col-md-3">
